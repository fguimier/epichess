...
SOURCES= socketserver.c socketclient.c bitboards.c b_deplace.c list.c pieces.c echiquier.c deplace.c sdl.c pgn.c pgn_read.c sdl_event.c loop.c gui_tmp.c
HEADERS= ${SOURCES:.c=.h}
OBJECTS= ${SOURCES:.c=.o}
